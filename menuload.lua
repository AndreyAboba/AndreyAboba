    ...
    if UI.Tabs.Combat then
        ...
        if UI.Sections.GunSilent then
            ...
            UI.Sections.GunSilent:Button({
                Name = "Sync Settings",
                Callback = function()
                    uiElements.GSEnabled.Callback(GunSilent.Settings.Enabled.Value)
                    uiElements.RangePlus.Callback(GunSilent.Settings.RangePlus.Value)
                    uiElements.Rage.Callback(GunSilent.Settings.Rage.Value)
                    uiElements.DoubleTap.Callback(GunSilent.Settings.DoubleTap.Value)
                    uiElements.HitPart.Callback(GunSilent.Settings.HitPart.Value)
                    uiElements.FakeDistance.Callback(GunSilent.Settings.FakeDistance.Value)
                    uiElements.ShotgunSupport.Callback(GunSilent.Settings.ShotgunSupport.Value)
                    uiElements.GenerateBullets.Callback(GunSilent.Settings.GenBullet.Value)
                    uiElements.TestGenerateBullets.Callback(GunSilent.Settings.TestGenBullet.Value)
                    uiElements.GSUSEFOV.Callback(GunSilent.Settings.UseFOV.Value)
                    uiElements.GSFOV.Callback(GunSilent.Settings.FOV.Value)
                    uiElements.GSShowCircle.Callback(GunSilent.Settings.ShowCircle.Value)
                    uiElements.GSCircleMethod.Callback(GunSilent.Settings.CircleMethod.Value)
                    uiElements.GSGradientCircle.Callback(GunSilent.Settings.GradientCircle.Value)
                    uiElements.GSGradientSpeed.Callback(GunSilent.Settings.GradientSpeed.Value)
                    uiElements.SortMethod.Callback(GunSilent.Settings.SortMethod.Value)
                    uiElements.TargetVisual.Callback(GunSilent.Settings.TargetVisual.Value)
                    uiElements.HitboxVisual.Callback(GunSilent.Settings.HitboxVisual.Value)
                    uiElements.PredictVisual.Callback(GunSilent.Settings.PredictVisual.Value)
                    uiElements.ShowDirection.Callback(GunSilent.Settings.ShowDirection.Value)
                    uiElements.ShowTrajectory.Callback(GunSilent.Settings.ShowTrajectoryBeam.Value)
                    uiElements.ShowFullTrajectory.Callback(GunSilent.Settings.ShowFullTrajectory.Value)
                    uiElements.TrackTarget.Callback(GunSilent.Settings.TrackTarget.Value)
                    uiElements.ChamsColor.Callback(GunSilent.Settings.ChamsColor.Value)
                    uiElements.HitChance.Callback(GunSilent.Settings.HitChance.Value)
                    uiElements.LatencyCompensation.Callback(GunSilent.Settings.LatencyCompensation.Value)
                    uiElements.AdvancedPrediction.Callback(GunSilent.Settings.AdvancedEnabled.Value)
                    uiElements.VehicleFactor.Callback(GunSilent.Settings.AdvancedVehicleFactor.Value)
                    uiElements.PlayerFactor.Callback(GunSilent.Settings.AdvancedPedestrianFactor.Value)
                    uiElements.Agressivness.Callback(GunSilent.Settings.AdvancedPredictionAggressiveness.Value)
                    uiElements.LowDistanceMulti.Callback(GunSilent.Settings.AdvancedSmallDistanceSpeedFactorMultiplier.Value)
                    uiElements.SlowVehicleMulti.Callback(GunSilent.Settings.AdvancedSlowVehiclePredictionFactor.Value)
                    uiElements.FastPredictionLimit.Callback(GunSilent.Settings.AdvancedFastVehiclePredictionLimit.Value)
                    uiElements.PositionHistory.Callback(GunSilent.Settings.AdvancedPositionHistorySize.Value)
                    uiElements.SmoothingFactor.Callback(GunSilent.Settings.AdvancedSmoothingFactor.Value)
                    uiElements.VehicleYCorrection.Callback(GunSilent.Settings.AdvancedVehicleYCorrection.Value)
                    uiElements.VisualUpdate.Callback(GunSilent.Settings.VisualUpdateFrequency.Value)
                    uiElements.TeleportSpeed.Callback(GunSilent.Settings.AdvancedTeleportThreshold.Value)
                    uiElements.TPLimit.Callback(GunSilent.Settings.AdvancedMaxSpeed.Value)
                    uiElements.BulletSpeed.Callback(GunSilent.Settings.PredictBullet.Value)
